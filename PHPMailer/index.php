...
try {
    ...
    $mail->Password   = 'fbaxfafeuwdzzwtz';                               //SMTP password gerado exclusivo para este envio, não é a mesma senha do email.
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = 

    //Recipients
    $mail->setFrom('gustamarsil@gmail.com', 'Gustavo');
    $mail->addAddress('gustamarsil@gmail.com', 'Gustavo');     //Add a recipient
    $mail->addReplyTo('gustamarsil@gmail.com', 'Gusavo');
